...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AcademyPortal.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AcademyPortal.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("AcademyPortal.Models.UserRole", b =>
                {
            ...
            modelBuilder.Entity("AcademyPortal.Models.Batch", b =>
                {
                    ...
                    b.HasOne("AcademyPortal.Models.ApplicationUser", "CreatedBy")
            ...
            modelBuilder.Entity("AcademyPortal.Models.BatchUser", b =>
                {
                    ...
                    b.HasOne("AcademyPortal.Models.ApplicationUser", "User")
                        .WithMany("Batches")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AcademyPortal.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AcademyPortal.Models.UserRole", b =>
                {
                    b.HasOne("AcademyPortal.Models.ApplicationRole", "ApplicationRole")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AcademyPortal.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("UserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
